...
def shortest_path(source, target):
    ...
    while not frontier.empty():
        ...
        for movie_id,neighbor_person_id in neighbors_for_person(current_person_id):
            #print(neighbors_for_person(current_person_id))
            if neighbor_person_id not in explored_states:
                new_node = Node(state = neighbor_person_id,parent = current_node,action = movie_id)
                frontier.add(new_node)
                explored_states.add(neighbor_person_id)
    return None
